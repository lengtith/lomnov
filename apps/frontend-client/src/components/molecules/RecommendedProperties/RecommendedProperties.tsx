...
const ItemCard = dynamic(()=>import("../item-card/ItemCard"))
const ArrowDown = dynamic(()=>import("@/icons").then(icon => icon.ArrowDown))
const ArrowUp = dynamic(()=>import("@/icons").then(icon => icon.ArrowUp))
