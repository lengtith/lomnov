...
const SelectProperties = dynamic(()=>import("@/components/molecules/select-properties/SelectProperties"), {ssr: false})
const SelectLocations = dynamic(()=>import("@/components/molecules/select-locations/SelectLocations"), {ssr: false})
const SelectPrice = dynamic(()=>import("@/components/molecules/select-price/SelectPrice"), {ssr: false})
