...
const FacebookF = dynamic(()=>import("@/icons").then(icon => icon.FacebookF))
const Telegram = dynamic(()=>import("@/icons").then(icon => icon.Telegram))
const TellPhone = dynamic(()=>import("@/icons").then(icon => icon.TellPhone))
const Share = dynamic(()=>import("@/icons").then(icon => icon.Share))
