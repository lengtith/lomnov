...
const Slider = dynamic(()=>import("@/components/molecules/slider/Slider"));
const ItemCardNearlyLocationList = dynamic(()=>import("@/components/molecules/item-card-nearly-location-list/ItemCardNearlyLocationList"));
const ItemCardPopularLocationList = dynamic(()=>import("@/components/molecules/item-card-popular-location-list/ItemCardPopularLocationList"));
const HeroSection = dynamic(()=>import("@/components/organisms/hero-section/HeroSection"));
      ...
      <div className=" flex flex-col lg:flex-row justify-between gap-20 xl:w-[1300px] m-auto py-20 lg:py-40 px-2 lg:px-20">
        ...
        <div className=" flex justify-end">
          <div className="w-[300px] h-[200px] rounded-2xl overflow-hidden">
            <Image src={logSkyBar} alt="" width={"300"} />
          </div>
        </div>
      </div>
      <section></section>
