...
const PropertyTypeInfo = dynamic(()=>import("../../../../components/organisms/property-type-info/PropertyTypeInfo"));
const PropertyDescription = dynamic(()=>import("../../../../components/organisms/property-description/PropertyDescription"));
const Map = dynamic(()=>import("../../../../components/molecules/map/Map"));
const RecommendedProperties = dynamic(()=>import("@/components/molecules/RecommendedProperties/RecommendedProperties"));
const UserListed = dynamic(()=>import("@/components/organisms/user-listed-property/UserListed"));
// Fetch property data
